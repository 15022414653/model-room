...
public:
	...
	UFUNCTION(BlueprintCallable, Category=Values)
		void Setup(EMORTAction action, TArray<AActor*> actors, TArray<UObject*> assets, bool renameProjectAssets, bool renameWorldActors, FString textToFind, FString targetText, FString RegexPattern, int32 CapturingGroupNumber, int32 startNumber, bool numeratePosition, FString numerateSeparator, int32 charsToRemove);
...
private:
	...
	int32 m_startNumber;
	bool m_numeratePosition;
	FString m_numerateSeparator;
